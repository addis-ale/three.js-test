...
/**
 * Custom shader material for PCB copper elements
 * Implements procedural copper generation, solder mask overlay, and interaction effects
 */
  ...
  public static createMaterial(): THREE.ShaderMaterial {
    return new THREE.ShaderMaterial({
      uniforms: {
        ...
        uBaseColor: { value: new THREE.Color(0x72, 0x45, 0x20) } // Copper base color
      },
